...
### temperature: $name = "Living Room Temperature", $settable = "false", $unit = "°C", $datatype = "float"
### humidity: $name = "Living Room Humidity", $settable = "false", $unit = "%", $datatype = "integer"
# heatpump
## $name = "Living Room Heatpump Control"
## $type = "ir"
## $properties = "heating":
### heating: $name = "Heatpump Heating Enabled", $settable = "true", $datatype = "boolean"
# corner-light
## $name = "Living Room Corner Light"
## $type = "light"
## $properties = "powered":
### heating: $name = "Living Room Corner Light Powered", $settable = "true", $datatype = "boolean"
